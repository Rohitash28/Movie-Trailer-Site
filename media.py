...
class Movie(object):
    """This class stores the movie related information
    ...
    Attributes:
        ...
        release_date: A string to store the initial release date of the movie
    """

    def __init__(self, movie_title, movie_storyline, poster_image,
                 trailer_youtube, movie_release_date):
        """Initializes Movie class variable instances"""
    ...
    def show_trailer(self):
        """Plays the movie trailer on the page in the web browser"""
